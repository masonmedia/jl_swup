    ...
    <main id="terms" role="main">
        ...
        <div class="container-fluid bg-light">
            <div class="row d-flex">
                <!--table of contents-->
                <div id="contents" class="col-xl-12 d-flex flex-column justify-content-center align-items-center min-50 rounded rounded p-4">
                    <div class="wrap d-flex flex-column justify-content-center align-items-start text-left n w-100 h-100 border rounded bg-white bg-dots px-5 pb-5 pt-4 shadow">
                        <h2 class="h5 pt-3 pb-4 m-0 text-secondary border-bottom w-100">Last updated: February 14, 2019</h2>
