...
<!--banner-->
    ...
    <div id="banner" role="banner" class="container-fluid p-0">
        <div class="row d-flex min-700-lg relative py-5 text-light">
           <img class="img-full absolute z-0 left-0 filter-dark up up-med" src="/assets/img/jaxx-terms.jpeg" alt="Jaxx Liberty intellectual property.">
           <div class="offset-lg-2"></div>
            <div class="col-lg-8 d-flex flex-column justify-content-center align-items-center text-center ts p-5">
                ...
                <h2 class="site-title ds-black font-weight-bold zoom zoom-med">Intellectual Property</h2>
            ...
            <div class="row d-flex relative p-4 min-500 bg-light stagger-right">
                <div class="col-lg-12 d-flex flex-column justify-content-center align-items-center text-left mt-2 right">
                   <div class="wrap d-flex flex-column justify-content-center align-items-start text-left w-100 h-100 border rounded bg-white p-5 relative">
                        ...
                        <!--trademarks-->
                        <h3 class="h4 font-weight-bold py-2">Trademarks</h3>
                        <p>Jaxx Liberty is made by Decentral Inc. “Jaxx”, “Decentral”, and the unique words, phrases, images, and visual styles that distinguish us and our services from others, and from others’, are registered or unregistered trademarks of Decentral Inc.
                        <p>Other words, phrases, images, and visual styles displayed in Jaxx Liberty are the trademarks of third parties. These third parties include Bitcoin Magazine Bitcoinist, Coindesk, Cointelegraph, Nulltx, and ShapeShift.</p>
                        <p>Trademark law helps to prevent confusion as to who performs, offers, or endorses what services. We reserve our rights in the use of our trademarks, ask that others not use them without our permission, and suggest third-party trademarks be approached in the same way.</p>
                        <!--Text and Images-->
                        <h3 class="h4 font-weight-bold py-2">Text and Images</h3>
                        <p>Text and images authored by Decentral are licensed to you under the Creative Commons Attribution 4.0 International licence. This means that you may reuse and remix them, but must provide attribution, include the notices that that license requires, and confuse noone as to text’s or an image’s source. Because blockchain-based digital assets are especially vulnerable to impersonation attacks, we will enforce our rights strictly where warranted.
                        <p>Text and images marked as authored by third parties are subject to their copyright. For instance, Jaxx Liberty’s news module integrates news snippets distributed to us through third-party RSS feeds. They link back to the articles designated in the feed by their publisher. Those articles are subject to the copyright rights of their creators, and of those to whom their creators have delegated those rights.</p>
                        <p>We’ll change up, from time to time, the RSS feeds our news module flows through, and sources whose snippets we make available. We always reserve the right to do that.</p>
                        <!--Software Libraries-->
