...
?>          
        ...
        <div class="row d-flex min-700-lg relative py-5 text-light">
           ...
           <div class="offset-lg-2"></div>
            <div class="col-lg-8 d-flex flex-column justify-content-center align-items-center text-center ts p-5">
                <h1 class="h4 mt-3 ds-black zoom">Jaxx Liberty Terms of Service</h1>
                <h2 class="site-title ds-black font-weight-bold zoom zoom-med">This is our agreement with you.</h2>
    ...
    <main id="sec-1" role="main"> 
        <div id="sec-1" class="container-fluid p-0 text-secondary">
            <div id="contents" class="row d-flex relative p-4 min-500 bg-light stagger-right">
                <section>
                    <!--table of contents-->
                    <article>
                        <div class="col-xl-12 d-flex flex-column justify-content-center align-items-center text-left mt-2 right">
                           <div class="wrap d-flex flex-column justify-content-center align-items-start text-left w-100 h-100 border rounded bg-white p-5 relative">
                                ...
                                <h4 class="mb-0 font-weight-bold py-2"><a href="#privacy">2. Privacy</a></h4>
                                <ul class="list-unstyled d-flex flex-wrap">
                                    <li class="py-2 ml-2"><a href="#privacy">2.1 Approach</a></li>
                                    <li class="py-2 ml-2"><a href="#p-1">2.2 Collection</a></li>
                                    <li class="py-2 ml-2"><a href="#p-2">2.3 Retention</a></li>
                                    <li class="py-2 ml-2"><a href="#p-3">2.4 Permissions</a></li>
                                </ul>
                                <h4 class="mb-0 font-weight-bold py-2"><a href="#obligations">3. Obligations</a></h4>
                                <ul class="list-unstyled d-flex flex-wrap">
                                ...
                                <h4 class="mb-0 font-weight-bold py-2"><a href="#constraints">4. Constraints</a></h4>
                                <ul class="list-unstyled d-flex flex-wrap">
                                ...
                                <h4 class="mb-0 font-weight-bold py-2"><a href="#i-1">5. Interpretation</a></h4>
                                <ul class="list-unstyled d-flex flex-wrap">
                   ...
                   <article>
                        <div class="col-xl-12 d-flex flex-column justify-content-center align-items-center pt-4">
                            <div class="wrap d-flex flex-column justify-content-center align-items-start text-left w-100 h-100 border rounded bg-white p-5">
                                ...
                                <p><span class="font-weight-bold">1.1 What: </span>Jaxx Liberty is non-custodial blockchain software for people. Its tools help users interact with third-party blockchain coins, tokens, and cryptocurrencies (together, <em>"digital assets"</em>), and organize information about them.</p>
                                <div id="b-2"></div>
                                ...
                                <!--1.2-->
                                <p><span class="font-weight-bold">1.2 How: </span>You can use Jaxx Liberty software, services, and support at no charge, as long as you abide by these terms. You're free to terminate the agreement by stopping to use Jaxx Liberty; we're free to stop providing it.</p>
                                <div id="b-3"></div>
                                ...
                                <!--1.3-->
                                <p><span class="font-weight-bold">1.3 Who: </span>We're Decentral Inc. (<a href="https://decentral.ca" target="_blank"><span class="orange">decentral.ca</span></a>), a Canadian corporation (<a href="mailto:info@jaxx.io"><span class="orange">info@jaxx.io</span></a>; P.O. Box P. O. Box 292, Station B, Toronto ON, M5T 2W2), which makes and maintains the Jaxx Liberty software, and can assign it only to someone who takes over the software or our company.</p>
                    ...
                    <article>  
                        <div class="col-xl-12 d-flex flex-column justify-content-center align-items-center pt-4">
                            <div class="wrap d-flex flex-column justify-content-center align-items-start text-left w-100 h-100 border rounded bg-white p-5">
                                ...
                                <p>Decentral is exposed to the limited personal information from Jaxx Liberty users described below. But we: avoid retaining personal information we’re exposed to; minimize the identifiers we have to generate; and will provide and erase any holdings on request: <a href="mailto:legal@jaxx.io"><span class="orange">legal@jaxx.io</span></a>. We bind our staff and seek to bind <a href="https://jaxx.io/thirdparties-current.html"><span class="orange">every relevant contractor</span></a> to confidentiality agreements. We use only encrypted connections between our own servers, and insist on them with third-party servers.</p>
                                <div id="p-1"></div>
                                <!--2.2-->
                                <p><span class="font-weight-bold">2.2. Limiting what we collect: </span>Jaxx Liberty has no accounts, because your mnemonic phrase and private keys are none of our business. But Jaxx Liberty does (i) undertake pseudonymous metrics collection; (ii) provide user support; (iii) derive a persistent “Unity” blockchain address from your mnemonic, and allow you to pair it with an optional “myJAXX” display name and email address.</p>
                                <div id="p-2"></div>
                                <ul>
                                    <li><p>Pseudonymous metrics are generated by collecting four types of information, and retaining them – linked together – until the end of the calendar month. The four types of information are: when you first installed Jaxx Liberty on your device; the operating system you’re running it on; the country to which we think your Internet Protocol address resolves; and when you clicked on each Jaxx Liberty module. We retain these data till the end of each calendar month, aggregate them to generate monthly statistics, then discard them completely. They’re never retained for more than 31 days.</p></li>
                                    <li><p>User support is run separately from the Jaxx Liberty systems, therefore decoupled from pseudonymous metrics. Providing personal information within user support – like an email address – exposes it to a <a href="https://jaxx.io/thirdparties-current.html"><span class="orange">third party bound contractually to respect your privacy.</span></a></p></li>
                                    <li><p>Unity address, a persistent pseudonym, is decoupled from your Internet Protocol address, blockchain activity, and device information. We can’t deduce your mnemonic phrase from it, don’t have information about whose it is, don’t expose it outside our systems, and don’t currently collect it. But if you opt in to myJAXX by entering a display name and email address – giving us a way to provide you with updates and interact with your display name for future in-app gamification – then we link your Unity address with these, which we retain. You can always withdraw consent for email subscriptions by clicking on the link at the bottom of the email.</p></li>
                                </ul>
                                <!--2.3-->
                                <p><span class="font-weight-bold">2.3. Minimizing what we retain: </span> Using the Internet means <a href="https://panopticlick.eff.org/" target="_blank"><span class="orange">leaking personal information.</span></a> When your Jaxx Liberty establishes an encrypted connection to our <a href="https://aws.amazon.com/privacy/"><span class="orange">AWS-hosted</span></a> virtual servers, your: Internet Protocol address, device type, operating system language, and monthly-discarded client information (install date, operating system, perceived country, module clicks) are logged.</p>
                                <p>We parse each log; increment relevant non-personal statistics counters, including within monthly-discarded client information; and delete the raw log within 24 hours. But there are three circumstances where we’re required to go beyond that:</p>
                                <ul>
                    ...
                    <article>
                        <div id="ob-1" class="col-xl-12 d-flex flex-column justify-content-center align-items-center pt-4">
                            <div class="wrap d-flex flex-column justify-content-center align-items-start text-left w-100 h-100 border rounded bg-white p-5">
                                ...
                                <!--3.2-->
                                <p><span class="font-weight-bold">3.2. Act Prudently: </span>Decentral doesn't create, and has no control over, digital assets you interact with through Jaxx Liberty -- so it's up to you to interact with them prudently by doing these three things.</p>
                                ...
                                <!--3.3-->
                                <p><span class="font-weight-bold">3.3. Play Nicely: </span> Decentral has a strong commitment to user autonomy. But there are some things either Jaxx isn't designed to support, or Decentral isn't allowed to. You agree not to:</p>
                                ...
                                <!--3.4-->
                                <p><span class="font-weight-bold">3.4. Respect Others’ Work: </span>Jaxx Liberty is made up of intellectual property held by Decentral, like copyright in Jaxx Liberty's code and in our text, images, and sounds; and trademarks in the distinctive words, symbols, and designs that identify Decentral and Jaxx.</p>
                    ...
                    <article>
                        <div id="c-1" class="col-xl-12 d-flex flex-column justify-content-center align-items-center min-50 pt-4">
                            <div class="wrap d-flex flex-column justify-content-center align-items-start text-left w-100 h-100 border rounded bg-white p-5">
                                ...
                                <!--4.2-->
                                <p><span class="font-weight-bold">4.2. Moving Parts: </span>Using software to interact with digital assets is risky. It depends on a complex chain of moving parts working together, and working properly.</p>
                                ...
                                <!--4.3-->
                                <p><span class="font-weight-bold">4.3. Blockchain Interaction: </span>Jaxx Liberty provides functions for sending digital assets' transfer instructions. Jaxx Liberty doesn't control the blockchains to which the instructions are sent: the only authentic transaction record is the blockchain.</p>
                    ...
                    <article>
                        <div id="i-1" class="col-xl-12 col-md-12 d-flex flex-column justify-content-center align-items-center pt-4 mb-4">
                            <div class="wrap d-flex flex-column justify-content-center align-items-start border rounded w-100 h-100 border rounded bg-white p-5">
                                ...
                                <!--5.2-->
                                <p id="i-3"><span class="font-weight-bold">5.2. Dispute Resolution: </span>Other than conflicts of law principles, this agreement is governed by the laws applicable in Toronto, Ontario, Canada, to whose courts we both agree to submit disputes we haven't been able to resolve between us. The Convention for the International Sale of Goods doesn't apply.</p>
                                <!--5.3-->
