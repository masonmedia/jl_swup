            ...
            <div class="row pt-0 p-4">
                <div class="col-sm-12">
                    <div class="wrap border-bottom pb-3">
                        <img class="jaxx-logo-text d-inline mr-2 align-bottom" src="/img/JaxxLiberty_Logo_Grouped.svg" alt="Jaxx Liberty">
                        <h1 class="section-title font-weight-bold pb-2 m-0">Change Log</h1>
                    </div>
                    <!--content-->

                    <h3 class="orange border-bottom py-3 m-0">Jaxx Liberty 2.1.3:</h3>
                    ...
                    <h3 class="orange border-bottom py-3 m-0">Jaxx Liberty 2.1.2:</h3>
                    ...
                    <h3 class="orange border-bottom py-3 m-0">Jaxx Liberty 2.1.1:</h3>
                    ...
                    <h3 class="orange border-bottom py-3 m-0">Jaxx Liberty 2.1.0:</h3>
                    ...
                    <h3 class="orange border-bottom py-3 m-0">Jaxx Liberty 2.0.6:</h3>
                    ...
                    <h3 class="orange border-bottom py-3 m-0">Jaxx Liberty 2.0.5:</h3>
                    ...
                    <h3 class="orange border-bottom py-3 m-0">Jaxx Liberty 2.0.4 (Windows and Linux Hotfix):</h3>
                    ...
                    <h3 class="orange border-bottom py-3 m-0">Jaxx Liberty 2.0.3:</h3>
                    ...
                    <h3 class="orange border-bottom py-3 m-0">Jaxx Liberty 2.0.1 (Hotfix):</h3>
