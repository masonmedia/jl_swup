    ...
    <div id="sec-1" class="container-fluid p-0 text-secondary">
        ...
        <section>
            <div id="sec-1" class="row d-flex min-500 relative bg-white p-5 stagger-right">
                ...
                <div class="col-lg-6 d-flex flex-column justify-content-center align-items-start text-left text-secondary o-12 right right-med">
                    <p class="p-big pt-3 m-0 slide-right">We built Jaxx Liberty with security in mind - to keep your digital assets safe when using it.  Security is a priority from the design stage right through to development, including a rigorous and ongoing code review process. Security is in our DNA.</p>
        ...
        <section>
            <div id="sec-6" class="row d-flex p-5 min-500 bg-white stagger-right">
                ...
                <div class="col-lg-6 d-flex flex-column justify-content-center align-items-start text-left text-secondary o-12 right right-med">
                    <p class="p-big pt-3 m-0 slide-right">Sync Jaxx Liberty across all platforms and devices. Your 12-word backup phrase is all you’ll need to manage your digital assets on all your devices. Whether it’s iOS, Android, Mac, Windows, Linux or Google Chrome Extension, we’ve got you covered.</p>
                    <div class="right right-slow">
