...
<div id="banner" role="banner" class="container-fluid p-0">
    <div class="row d-flex min-700-lg py-5 text-light relative">
       <img class="img-full absolute z-0 left-0 up up-med" src="assets/img/jaxx-pc-coffee.png" alt="Jaxx Liberty is your all-in-one digital asset wallet.">
...
<main>
    <div id="features" class="container-fluid p-0 text-secondary">
        ...
        <section>
           <div class="row d-flex relative bg-orange-gradient text-light stagger-up">
        ...
        <section>
            <div class="row d-flex p-5 bg-light stagger-up">
