 ...
 <footer>
     <div class="container-fluid p-0 relative stagger-down">
         <div
             class="row d-flex d-flex justify-content-center align-items-end text-secondary bg-light text-secondary px-3 pt-5">

             <div class="col-lg-3 col-sm-6 px-4 py-3 skew down">
             ...
             <div class="col-lg-3 col-sm-6 px-4 py-3 skew down">
                 <ul class="list-unstyled w-100 slide-down">
                     ...
                     <hr class="hr-big border-0 bg-secondary">
                     <li><a href="https://play.google.com/store/apps/details?id=com.liberty.jaxx"
                             target="_blank">Android</a></li>
                     <li><a href="https://itunes.apple.com/us/app/jaxx-liberty/id1435383184?ls=1&mt=8"
             ...
             <div class="col-lg-3 col-sm-6 px-4 py-3 skew down">
                 <ul class="list-unstyled w-100 slide-down">
                     ...
                     <hr class="hr-big border-0 bg-secondary">
                     <li class=""><a href="https://www.facebook.com/JaxxWallet" target="_blank"
                             onclick="googleAnalyticsTrigger('Facebook', 'Footer')">Facebook</a></li>
                     <li><a href="https://twitter.com/jaxx_io" target="_blank"
                             onclick="googleAnalyticsTrigger('Twitter', 'Footer')">Twitter</a> / <a
                             href="https://twitter.com/Jaxx_Support" target="_blank"
                             onclick="googleAnalyticsTrigger('Twitter_Support', 'Footer')">Twitter Support</a></li>
                     <li><a href="https://www.instagram.com/jaxx_io/" target="_blank">Instagram</a></li>
                     <li><a href="https://www.reddit.com/r/jaxx/" target="_blank"
                             onclick="googleAnalyticsTrigger('Reddit', 'Footer')">Reddit</a></li>
                 </ul>
             </div>

             <div class="col-sm-12 d-flex justify-content-center text-center py-4 navy slide-down">
                 <p class="font-weight-light m-0"><a href="https://decentral.ca/" target="_blank"
                         onclick="googleAnalyticsTrigger('decentral.ca', 'Legal_Footer')">&copy; Decentral Inc.</a> <img
                         class="footer-leaf mx-1" src="/assets/img/jaxx-maple-leaf-navy-2.png" alt="Decentral inc.">
                     Made with love in Canada</p>
             </div>
         </div>
         <!--end row-->
     </div>
