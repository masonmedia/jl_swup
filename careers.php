...
<div id="banner" role="banner" class="container-fluid p-0">
    <div class="row d-flex min-700-lg py-5 text-light relative">
       ...
       <img class="img-full absolute z-0 left-0 filter-dark up up-med lazy" data-src="/assets/img/jaxx-sticker-cube.jpg" alt="At Decentral, we are building bleeding-edge, pro-privacy technologies at the core of the next Internet. A leading blockchain pioneer of Canada, we are the proud birthplace of Ethereum and, now, steward software at the interface of the cryptocurrency and distributed ledger revolution.">
        ...
        <div class="col-lg-7 d-flex flex-column justify-content-end align-items-start text-left ts p-5">
            ...
            <h2 class="site-title font-weight-bold ds-black zoom zoom-med">Become a part
            <span class="d-table">of the Decentral
            <span class="d-table">Team.</span>
            </h2>
        </div>
...
<main>
    <div class="container-fluid p-0 text-secondary">
        ...
        <section>
            <div id="sec-1" class="row d-flex min-500 relative bg-white p-5 border-bottom">
                <div class="col-lg-5 d-flex flex-column justify-content-center align-items-start text-left right">
                    <h2 class="h4 slide-up">Decentral Inc.</h2>
                    <h3 class="section-title text-dark mb-0 slide-up">We’re leading the decentralized movement. Are you in?</h3>
                ...
                <div class="col-lg-7 d-flex flex-column justify-content-center align-items-start text-left text-secondary p-3 o-12 right right-med">
                    <p class="p-big py-3 m-0 pl-4 border-left">At Decentral, we are building bleeding-edge, pro-privacy technologies at the core of the next Internet. A leading blockchain pioneer of Canada, we are the proud birthplace of Ethereum and, now, steward software at the interface of the cryptocurrency and distributed ledger revolution. To see if we’d make a good fit, send us your resume at <a href="mailto:careers@decentral.ca?subject=Applying for a Position" class="orange text-bold">maggie@decentral.ca</a>. See below for more information and available positions.</p>

                    <!-- We build products that help millions around the world to secure, manage and exchange their blockchain assets in one easy app. We’re keen to meet curious minds who are interested in exploring the potential of decentralized technology. To see if we’d make a good fit, send us your resume at <a href="mailto:careers@decentral.ca?subject=Applying for a Position" class="orange text-bold">maggie@decentral.ca</a>.  See below for open positions. -->
                </div>
            </div>
        </section>

        <section>
            <div id="careersIntroList" class="row d-flex min-500 relative bg-light p-5 border-bottom">
                <div class="col-lg-5 d-flex flex-column justify-content-center align-items-start text-left right">
        ...
        <section>
            <div id="careers" class="row d-flex p-5 min-500 bg-white stagger-up">
                <div class="col-lg-5 d-flex flex-column justify-content-center align-items-start text-left right">
                ...
                <div class="col-lg-7 d-flex flex-column justify-content-center align-items-start text-left text-secondary pt-3 o-12 right right-med">
                    <p class="p-big m-0 pl-4 p-3 border-left">Our flagship product is Jaxx Liberty, a multi-asset wallet software as a service that packages live market data with user portfolios, news, and third-party fintech integration, on top of high-performance indexing and data summarization in a cloud back-end.  Working closely with our Chief Technology Officer, help push the Jaxx Liberty architecture even further by diversifying our product line into enterprise and financial markets. Find out more below.</p>
                </div>
                            ...
                            <div class="card-header" id="headingOne" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                <div class="media">
                                    ...
                                    <div class="media-body align-self-center">
                                        <h3 class="p-btn font-weight-bold"><code class="orange">Learn more</code> <i class="fa fa-code fa-btn orange"></i></h3>
                                    </div>
                                </div>
                            </div>
